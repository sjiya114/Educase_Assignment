        ...
        <div className='flex flex-col'>
           <form onSubmit={handlesubmit}> 
            ...
            <div>
              ...
              <input onChange={(e)=>{setPassword(e.target.value)}} minLength={8} className='border-2 px-2 py-1 mb-1 w-full border-gray-400 rounded-md mt-4' placeholder='Enter password'  name='Password' type="password" required /></div>
               <div className='mt-4'>
